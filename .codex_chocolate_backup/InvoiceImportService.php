...
final class InvoiceImportService
{
    ...
    private function applyManualLineOverrides(array $lines, array $post): array
    {
        ...
        foreach ($lines as &$line) {
            ...
            $line['porcentaje_iva'] = $this->sanitizePercent($line['porcentaje_iva'] ?? null, $defaultVat);

            if (($line['porcentaje_iva'] ?? null) === null && $defaultVat !== null) {
                $line['porcentaje_iva'] = $defaultVat;
            }
